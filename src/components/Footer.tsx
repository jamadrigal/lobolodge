        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <div>
            ...
            <div className="flex flex-col gap-2">
              <a
                href="mailto:lobolodge1395@gmail.com"
                className="inline-flex items-center mb-2 text-gray-300 hover:text-white transition-colors duration-300"
              >
                <svg
                ...
                lobolodge1395@gmail.com
              </a>
            </div>
            <div className="flex flex-col gap-2">
              <a
                href="tel:+16238891125"
                className="inline-flex items-center mb-2 text-gray-300 hover:text-white transition-colors duration-300"
              >
                <svg
                  className="w-5 h-5 mr-2"
            ...
            <div className="flex flex-col gap-2">
              <a
                href="https://www.instagram.com/lobo_lodge_a_frame"
                target="_blank"
